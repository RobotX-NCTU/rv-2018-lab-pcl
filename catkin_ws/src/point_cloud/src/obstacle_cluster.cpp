...
void drawRviz(robotx_pcl_msgs::ObstaclePoseList); //draw marker in Rviz
...
void cluster_pointcloud()
{
  ...
  ec.setClusterTolerance (1.5); // unit: meter
...
void drawRviz(robotx_pcl_msgs::ObstaclePoseList ob_list){
